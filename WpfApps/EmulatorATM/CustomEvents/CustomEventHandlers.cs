...
namespace EmulatorATM.CustomEvents
{
    public class CustomEventHandlers
    {
        ...
        public delegate void DialButtonsEventHandler(object? sender, DialButtonsEventArgs e);
        public class DialButtonsEventArgs
        {
            public ViewModels.Controls.DialButtons btn;
            public DialButtonsEventArgs(ViewModels.Controls.DialButtons newBtn)
            {
                btn = newBtn;
            }
        }
